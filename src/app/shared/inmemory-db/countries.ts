...
export class RegionsDB{
  ...
  {name: 'Ashanti',
    Districts:[
      {name: 'Adansi Asokwa (<— Adansi North)'},
      {name: 'Adansi North'},
      {name: 'Adansi South'},
      ...
      {name: 'Akrofuom (<— Obuasi Municipal)'},
      {name: 'Amansie Central'},
      {name: 'Amansie South (— Amansie West)'},
      {name: 'Amansie West'},
      {name: 'Asante Akim Central Municipal'},
      {name: 'Asante Akim North'},
      {name: 'Asante Akim South Municipal'},
      {name: 'Asokore Mampong Municipal'},
      {name: 'Asokwa Municipal (— Kumasi Metropolitan)'},
      {name: 'Atwima Kwanwoma'},
      {name: 'Atwima Mponua'},
      {name: 'Atwima Nwabiagya Municipal (Atwima Nwabiagya South Municipal}'},
      {name: 'Atwima Nwabiagya North (— Atwima Nwabiagya Municipal}'},
      ...
      {name: 'Kumasi Metropolitan (incl. Bantama Municipal, Manhyia North Municipal, Manhyia South Municipal, Nhyiaeso Municipal, Subin Municipal)'},
      {name: 'Kwabre East'},
      {name: 'Kwadaso Municipal (— Kumasi Metropolitan)'},
      {name: 'Mampong Municipal'},
      {name: 'Obuasi East (— Obuasi Municipal)'},
      {name: 'Obuasi Municipal'},
      {name: 'Offinso Municipal'},
      {name: 'Offinso North'},
      {name: 'Oforikrom Municipal (— Kumasi Metropolitan)'},
      {name: 'Old Tafo Municipal (— Kumasi Metropolitan)'},
      {name: 'Sekyere Afram Plains'},
      {name: 'Sekyere Central'},
      {name: 'Sekyere East'},
      {name: 'Sekyere Kumawu'},
      {name: 'Sekyere South'},
      {name: 'Suame Municipal (— Kumasi Metropolitan)'},
    ]
  },
